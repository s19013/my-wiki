...
// 期待:パスワード再発行画面が表示される
test('画面遷移:パスワード再発行画面',async({page}) => {
    await page.goto(baseHome + 'login');
...
test('ログイン失敗:何も埋めてない',async({page}) => {
    await page.goto(baseHome + 'login');
...
// 条件:メアドの欄に適当な文字列を入れる
// 期待:｢[@]を挿入してください｣と表示される
test('ログイン失敗:メアド欄にメアド以外の文字列を入力',async({page}) => {
    await page.goto(baseHome + 'login');
...
// 条件:メアドだけ埋めた
// 期待:｢このフィールドを入力してください｣と表示される
test('ログイン失敗:メアドだけ埋めた',async({page}) => {
    await page.goto(baseHome + 'login');
...
// 条件:パスワードだけ埋めた
// 期待:｢このフィールドを入力してください｣と表示される
test('ログイン失敗:パスワードだけ埋めた',async({page}) => {
    await page.goto(baseHome + 'login');
...
// 条件:パスワードが間違ってる
// 期待:｢このフィールドを入力してください｣と表示される
test('ログイン失敗:パスワードが間違ってる',async({page}) => {
    await page.goto(baseHome + 'login');
    await page.getByLabel('メールアドレス').fill(testmail);
...
// 条件:パスワードが間違ってる
// 期待:｢このフィールドを入力してください｣と表示される
test('ログイン失敗:メアドが間違ってる',async({page}) => {
    await page.goto(baseHome + 'login');
